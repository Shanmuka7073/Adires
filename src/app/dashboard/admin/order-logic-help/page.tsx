...
import { orderLogicCodeText } from './code-text';
    ...
    return (
        <div className="container mx-auto py-12 px-4 md:px-6">
            <Card className="max-w-4xl mx-auto">
                ...
                <CardContent>
                   <Accordion type="single" collapsible className="w-full" defaultValue={orderLogicCodeText[0].path}>
                        {orderLogicCodeText.map((file) => (
