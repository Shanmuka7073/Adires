...
import { actionsCodeText } from './code-text';
                ...
                <CardHeader>
                    <CardTitle className="text-3xl font-headline flex items-center gap-2">
                       <Server className="h-8 w-8 text-primary" />
                        Server Actions Source Code
                    </CardTitle>
                    <CardDescription>
                        This is the source code for the main server actions file (`src/app/actions.ts`).
                    </CardDescription>
                </CardHeader>
                <CardContent>
                   <Accordion type="single" collapsible className="w-full">
                        {actionsCodeText.map((file) => (
