...
import { fingerprintHelpCodeText } from './code-text';
        ...
        <div className="container mx-auto py-12 px-4 md:px-6">
            <Card className="max-w-4xl mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>
                        This is the source code for the client-side fingerprint registration page (`src/app/dashboard/customer/fingerprint/page.tsx`).
                    </CardDescription>
                </CardHeader>
                <CardContent>
                   <Accordion type="single" collapsible className="w-full">
                        {fingerprintHelpCodeText.map((file) => (
