 ...
 * Optimized to sync with Business Identity for Merchants.
 */
  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-2xl animate-in fade-in duration-500">
        <div className="mb-8 flex items-center gap-4">
            ...
            <h1 className="text-4xl font-black uppercase italic tracking-tighter">My Profile</h1>
        </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <CardContent className="p-8 space-y-6">
                        ...
                        <FormField control={form.control} name="phone" render={({ field }) => (
                            <FormItem><FormLabel className="text-[10px] font-black uppercase opacity-40">Contact Number</FormLabel><FormControl><Input {...field} className="h-12 rounded-xl border-2 font-bold" /></FormControl></FormItem>
                        )} />
                        <FormField control={form.control} name="address" render={({ field }) => (
                            <FormItem><FormLabel className="text-[10px] font-black uppercase opacity-40">Full Address</FormLabel><FormControl><Input {...field} className="h-12 rounded-xl border-2 font-bold" /></FormControl></FormItem>
                        )} />
                    </CardContent>
